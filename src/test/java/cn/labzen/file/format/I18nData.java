...
//
//  public static I18nMessageSource prepare() {
//    // 初始化 i18n 文案源
//    I18nMessageSource messageSource = new ManualI18nMessageSource();
...
//    ManualI18nMessageSource messageSource = (ManualI18nMessageSource) I18nMessageSourceHolder.get();
//    messageSource.putAll("zh-CN", java.util.Map.ofEntries(
...
//    ManualI18nMessageSource messageSource = (ManualI18nMessageSource) I18nMessageSourceHolder.get();
//    messageSource.putAll("en-US", java.util.Map.ofEntries(
